...
public class Search {
		...
		public void SEARCHesponse() throws ParseException, org.json.simple.parser.ParseException{
			...
			RestAssured.baseURI = "https://hclconnectordev.dev.verify.ibmcloudsecurity.com/appcatalog/v1.0/templates/";
			...
			Response searchResponse = getRequest
					.get("https://hclconnectordev.dev.verify.ibmcloudsecurity.com/appcatalog/v1.0/templates/");
